...
public interface MxVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link MxParser#wow1}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitWow1(MxParser.Wow1Context ctx);
	/**
	 * Visit a parse tree produced by {@link MxParser#wow2}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitWow2(MxParser.Wow2Context ctx);
	/**
	 * Visit a parse tree produced by {@link MxParser#wow3}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitWow3(MxParser.Wow3Context ctx);
	/**
