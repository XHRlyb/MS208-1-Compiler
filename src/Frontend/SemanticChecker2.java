...
public class SemanticChecker2 implements ASTVisitor {
    ...
    public int for_id = 0, while_id = 0, if_id = 0;
    public LinkedList<Integer> for_idd = new LinkedList<Integer>();
    public LinkedList<Integer> while_idd = new LinkedList<Integer>();
    public LinkedList<Integer> if_idd = new LinkedList<Integer>();

    public int vid = 0, sid = 0;

    public SemanticChecker2(Scope glb) { this.glb = glb; }
    ...
    public void visit(forStmt o) {
        ...
        loopDep++; for_idd.addFirst(++for_id);
        cur = new Scope(cur, ++sid);
        o.body.accept(this);
        cur = cur.fa;
        loopDep--; for_idd.removeFirst();
    }
    @Override
    ...
    public void visit(varDefSigStmt o) {
        ...
        cur.defVar(o.nam, new varEntity(o.nam, varTyp), o.pos, ++vid);
    }
    @Override
    public void visit(whileStmt o) {
        ...
        loopDep++; while_idd.addFirst(++while_id);
        cur = new Scope(cur, ++sid);
        o.body.accept(this);
        cur = cur.fa;
        loopDep--; while_idd.removeFirst();
    }
    ...
    public void visit(classDef o) { //???
        ...
        cur = new Scope(cur, ++sid);
        curCls.varMap.forEach((key, value) -> cur.defVar(key, value, o.pos, ++vid));
    ...
    public void visit(funDef o) { //???
        ...
        cur = new Scope(cur, ++sid);
        o.params.forEach(x ->
                cur.defVar(x.nam, new varEntity(x.nam, glb.getTyp(x.typ)), x.pos, ++vid)
        );
        o.block.accept(this);
        cur = cur.fa;
