...
public class SemanticChecker implements ASTVisitor {
    ...
    public LinkedList<stmtNode> loop_idd = new LinkedList<>();
    ...
    public void visit(varDefSigStmt o) {
        ...
        //@o.scp = cur;
        o.var = new varEntity(o.nam, varTyp);
        if (cur == glb) o.var.isGlb = true;
    ...
    public void visit(memberExpr o) {
        ...
        if (o.bas.typ.isString() && o.isFun && o.nam.equals("substring")) {
            ...
            o.typ = fun;
            fun.fun = new Func("str_substring");
            fun.fun.rettyp = ir.getTyp(fun.retTyp);
            return;
        }
    ...
    public void visit(varExpr o) {
        o.var = cur.getVar(o.nam, o.pos, true);
        o.typ = o.var.typ;
        //@o.scp = cur;
        //@varEntity var;
        //@if (cur.contVar(o.nam, true)) {
    ...
    public void visit(classDef o) { //???
        ...
        if (o.constructor != null) {
            ...
            o.clsTyp.clsTyp.constructor = o.constructor.fun.fun;//@
        }
        //@o.scp = cur;
        cur = cur.fa;
        curCls = null;
    ...
    public void visit(funDef o) { //???
        ...
        o.retTyp = curRetTyp;//@
        o.fun.fun = new Func(o.nam);//@
        o.fun.fun.rettyp = ir.getTyp(o.retTyp);//@
        if (curCls != null) o.fun.fun.inCls = true;//@
        retDone = false;
        cur = new Scope(cur);
        ...
        o.params.forEach(x -> {
            x.var = new varEntity(x.nam, glb.getTyp(x.typ));
            cur.defVar(x.nam, x.var, x.pos);
        });
